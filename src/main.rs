...
enum Route {
    ...
    Home {},
    #[route("/blog/:id")]
    Blog { id: usize, name_city: String },
}
...
#[component]
fn Blog(id: usize, name_city: String) -> Element {
    rsx! {
              ...
              div {class:"flex",
                      div {class:"flex flex-col w-1/3",
                          ...
                          div {class:"bg-yellow-100 rounded-3xl p-6 flex flex-col items-center mb-8",
                              div { class:"text-6xl font-bold text-yellow-500 mb-4", "12°C"}
                              div { class:"text-gray-500", "Monday, 16:00"}
                              div { class:"flex items-center justify-center mt-8",
                              span {class:"text-lg font-medium text-gray-600", "Mostly Cloudy"}
                              }
                              div {class:"mt-4",
                          ...
                          div { class:"flex items-center mt-auto",
                            img {src:"https://via.placeholder.com/80x80", alt:"Location", class:"w-12 h-12 rounded-full mr-4"}
                              div {
                                  p {class:"text-gray-600", "New York, NY, USA"}
                              }
                              }
                      }
                        ...
                        class:"w-2/3 pl-8 flex flex-col justify-center",
                          div {class:"grid grid-cols-3 gap-6",
                              ...
                              div {class:"bg-gray-100 p-6 rounded-lg",
                                  ...
                                  div {class:"flex items-center",
                                  span {class:"text-4xl font-bold text-gray-700","7.70"}
                              ...
                              div {class:"bg-gray-100 p-6 rounded-lg",
                                  ...
                                  div {class:"flex items-center",
                                    span { class:"text-4xl font-bold text-gray-700", "12%"}
                                  div {class:"ml-4 text-gray-600", "Normal"}
    }
    }
